...
// Prompt Template
const MONGOOSE_PROMPT_TEMPLATE = `You are an expert TypeScript developer specializing in Node.js, Express, and MongoDB (using Mongoose).
...
const promptTemplate = PromptTemplate.fromTemplate(MONGOOSE_PROMPT_TEMPLATE);
